...
class Level2 : public Level
{
    ...
    static const int totalOpponent = 3;
    static int count;
    ...
    bool newGame;
    bool newGamePause;
    Opponent oppoCar[totalOpponent];
...
public:
    ...
    {
        ptr4 = new WhiteTriangle(484.f, 620.f, 13.f);
    }
    void constructOpponent()
    {
        // Add code here to initialize small boxes as needed
        oppoCar[0].makeOppo(700.f, 144.f, 40.f, 20.f);    // Initial direction is 1 (right)
        oppoCar[1].makeOppo(720.f, 173.f, 20.f, 10.f);   // Initial direction is -1 (left)
        oppoCar[2].makeOppo(690.f, 173.f, 20.f, 10.f);   // Initial direction is -1 (left)
        ...
        //Up boundary
        oppoCar[0].setUpBoundaryOpp(130.0);
        oppoCar[1].setUpBoundaryOpp(160.0);
        oppoCar[2].setUpBoundaryOpp(160.0);

        //Down boundary
        oppoCar[0].setDownBoundaryOpp(700.0);
        oppoCar[1].setDownBoundaryOpp(730.0);
        oppoCar[2].setDownBoundaryOpp(730.0);
    }
    ...
    void constructCircle()
    {
        ...
        ptr2[1] = new GreenCircle(574.f, 250.f, 13.f);
    ...
    void constructRedRect()
    {
        ...
        //Bottom left second
        ptr1[9] = new RedRectangle(170.f, 530.f, 13.f, 50.f);     //divider
        //ptr1[10] = new RedRectangle(170.f, 620.f, 13.f, 50.f);    //divider
        ptr1[10] = new RedRectangle(269.f, 620.f, 13.f, 37.f);    //divider

        //Bottom left third
        ptr1[11] = new RedRectangle(70.f, 521.f, 13.f, 50.f); //divider   5
        ptr1[12] = new RedRectangle(70.f, 620.f, 13.f, 50.f); //divider   4
        ptr1[13] = new RedRectangle(70.f, 719.f, 13.f, 50.f); //divider   3
        ptr1[14] = new RedRectangle(170.f, 719.f, 13.f, 50.f); //divider  2
        ptr1[15] = new RedRectangle(269.f, 719.f, 13.f, 37.f); //divider  1

        //Top right first
        ptr1[16] = new RedRectangle(487.f, 320.f, 13.f, 37.f);   //divider 

        //Top right second
        ptr1[17] = new RedRectangle(574.f, 317.f, 13.f, 50.f); //divider
        ...
        //Bottom right second
        //ptr1[24] = new RedRectangle(484.f, 620.f, 13.f, 37.f); //divider
        ptr1[25] = new RedRectangle(574.f, 620.f, 13.f, 50.f); //divider
        ptr1[26] = new RedRectangle(574.f, 530.f, 13.f, 50.f); //divider

        //Bottom right third
        ptr1[27] = new RedRectangle(484.f, 719.f, 13.f, 37.f); //divider
        ptr1[28] = new RedRectangle(574.f, 719.f, 13.f, 50.f); //divider
        ptr1[29] = new RedRectangle(680.f, 719.f, 13.f, 50.f); //divider
    ...
    {
       //Font an dtext variable of sfml
        Font font;
        Text scoreDisplay;
        Text lifeDisplay;
        ...
        srand(time(0));
        RenderWindow window(VideoMode(800, 800), "Level2");
        Clock clock;
        float timer = 0;
        //Defining function
        ...
        while (window.isOpen())
        {
            ...
            if (!pause || newGame)
            {
                ...
                for (int i = 0; i < numSmallBoxes; ++i)
                {
                    ...
                    {
                        float oppSpeed = 0.06f;
                        oppoCar[j].move(0.0f, oppSpeed);  //Here the y axis is zer as in level 1 the opponent car 
                        ...
                        if (oppoCar[j].getShape().getPosition().y < oppoCar[j].getUpBoundaryOpp())
                        {
                        ...
                        if (oppoCar[j].getShape().getPosition().y > oppoCar[j].getDownBoundaryOpp())
                        {
            ...
            else
            {
                ...
                RenderWindow pauseWindow(VideoMode(800, 800), "Pause Screen");
