...
{
    static const int totalRedFood = 31;
    ...
    static const int totalHexagon = 2;
...
public:
    ...
    void constructOpponent()
    {
        ...
        oppoCar[0].makeOppo(580.f, 700.f, 40.f, 20.f);    // Initial direction is 1 (right)
        oppoCar[1].makeOppo(570.f, 691.f, 20.f, 10.f);   // Initial direction is -1 (left)
        oppoCar[2].makeOppo(570.f, 729.f, 20.f, 10.f);   // Initial direction is -1 (left)
    ...
    {
        ptr3[0] = new OrangeHexagon(200.f, 620.f, 20.f);
        ptr3[1] = new OrangeHexagon(600.f, 317.f, 20.f);
    ...
    void constructRedRect()
    {
       ...
       // ptr1[16] = new RedRectangle(574.f, 317.f, 13.f, 50.f); //divider
        ptr1[16] = new RedRectangle(574.f, 250.f, 13.f, 50.f); //divider
        ptr1[17] = new RedRectangle(487.f, 250.f, 13.f, 37.f); //divider

        //Top right third
        ptr1[18] = new RedRectangle(680.f, 317.f, 13.f, 50.f); //divider
        ptr1[19] = new RedRectangle(680.f, 235.f, 13.f, 50.f); //divider
        ptr1[20] = new RedRectangle(680.f, 160.f, 13.f, 50.f); //divider
        ptr1[21] = new RedRectangle(487.f, 160.f, 13.f, 37.f); //divider
        ptr1[22] = new RedRectangle(574.f, 160.f, 13.f, 50.f); //divider

        //Bottom right first
        ptr1[23] = new RedRectangle(484.f, 530.f, 13.f, 37.f); //divider
        ...
        ptr1[29] = new RedRectangle(680.f, 620.f, 13.f, 50.f); //divider
        ptr1[30] = new RedRectangle(680.f, 527.f, 13.f, 37.f); //divider
    ...
    bool levels() override
    {
        ...
        srand(time(0));
        RenderWindow window(VideoMode(800, 800), "Level 3");
        Clock clock;
        float timer = 0;
        //Using finyt and text to dipslay the variable of clas 
        ...
        while (window.isOpen())
        {
            //This will diplay the live scroe on screen
            ...
            if (!pause || newGame)
            {
                ...
                for (int i = 0; i < numSmallBoxes; ++i)
                {
                    ...
                    //For hexagon
                    for (int l = 0; l < totalHexagon; l++)
                    {
                        OrangeHexagon* hexagonBound = dynamic_cast<OrangeHexagon*>(ptr3[l]);
                        if (hexagonBound != nullptr)
                        {
                            ...
                            if (smallBoxes[i].getShape().getGlobalBounds().intersects(bound))
                            {
                                ...
                                ptr3[l] = new OrangeHexagon(0.f, 0.f, 0.f);
                ...
                for (int i = 0; i < totalHexagon; i++)
                {
                    ptr3[i]->makeFood(window);
                }
            ...
            else
            {
                ...
                RenderWindow pauseWindow(VideoMode(800, 800), "Level 3");
